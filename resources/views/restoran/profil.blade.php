...
{{--                                 <div class="m-b-25"> 
                                    <img src="{{ $restoran->getAvatar()}}" class="img-radius rounded-circle" alt="User-Profile-Image">
                                </div> --}}
                                <h2 class="f-w-600">{{$restoran->nama_restoran}}</h2>
                              {{--   <a href="/restoran/{{$restoran->id}}/edit" class="btn btn-warning">Edit Profil</a> --}} <i class=" mdi mdi-square-edit-outline feather icon-edit m-t-10 f-16"></i>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="card-block">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <p class="m-b-10 f-w-600">Nama Restoran</p>
                                        <h6 class="text-muted f-w-400">{{ $restoran->nama_restoran}}</h6>
                                    </div>
                                    <div class="col-sm-6">
                                        <p class="m-b-10 f-w-600">Alamat Restoran</p>
                                        <h6 class="text-muted f-w-400">{{ $restoran->alamat_restoran}}</h6>
                                    </div>
                                </div>
                                {{--  --}}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <h6 class="text-muted f-w-400">{{$restoran->open}}</h6>
                                    </div>
                            ...
                            {{-- end of div row --}}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <h6 class="text-muted f-w-400">{{$restoran->close}}</h6>
                                    </div>
                ...
                <div class="card user-card-full">
                    <div class="row m-l-0 m-r-0">
                        <div class="col-sm-6">
                            ...
                            <div class="card-block">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                    @foreach($restoran->fasilitas as $fasilitas)
                                     {{--  --}}
                    ...
                    <div class="col-sm-6">
                            ...
                            <div class="card-block">
                                {{--  --}}
                                <h3 class="m-b-20 p-b-5 b-b-default f-w-600">Menu Restoran</h3>
                                <div class="row">
                                    <div class="col-sm-12">
                 ...
                 <div class="card user-card-full">
                    ...
                    {{-- Komentar --}}
                        <div class="col-sm-12">
                            ...
                            <div class="card-block">
                                ...
                                <form action="/restoran/{{$restoran->id}}/profil/postreview" style="margin-top:10px; display:none;" id="review-utama" method="POST">
                                    @csrf
                                    <input type="hidden" name="restoran_id" value="{{ $restoran->id}}">
                                    <input type="hidden" name="parent" value="0">
                                    <input type="hidden" name="cafe_id" value="0">
                    ...
                    <div class="col-sm-12">
                        <div class="card-header"><h1>Review</h1></div>
                            {{--  --}}
                            <div class="card-block">
                                @foreach($restoran->review()->orderBy('Created_at','desc')->get() as $review)
                   ...
                   <div class="clearfix"></div>
                    <p>{{$review->konten}}</p>
                        ...
                        <a class="pull-left" href="#">
                          <img class="media-object img-circle" src="{{$review->user->getAvatar()}}" alt="profile">
                        </a>
...
{{--                                  <li>
                        <img src="{{$review->user->getAvatar()}}" width="20px"class="rounded-circle">
                        <p>
                            <a href="#"></a>{{$review->konten}}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/restoran/{{$restoran->id}}/profil/fasilitas" method="POST">
    @csrf
        <input type="hidden" name="restoran_id" value="{{ $restoran->id}}">
        <input type="hidden" name="parent" value="0">
...
<div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/restoran/{{$restoran->id}}/profil/menu" method="POST">
    @csrf
        <input type="hidden" name="restoran_id" value="{{ $restoran->id}}">
        <input type="hidden" name="parent" value="0">
        <label for="exampleFormControlInput2">Menu Restoran</label>
